...
### Vad appen ska göra
Vi har fått i uppgift att välja ett projekt som vi ska göra i grupp. Vi har valt att övervaka en hemsida med hjälp av Logic App i Microsoft Azure som analyserar bland annat svarstid, om sidan är tillgänglig eller inte m.m.<br>
Vi har gjort en enkel app som läser av sidan Faultnode.se var 15 minut. Faultnode.se har bara ett syfte, det är att man ska kunna kontrollera sidan och få förutsägbara fel, tex lång svarstid, HTTP koder som 500, 503 och att sidan inte är åtkomlig. <br>
...
Condition – används för att kontrollera om ett villkor är sant eller falskt. Beroende på resultatet går Logic Appen vidare i antingen True- eller False-grenen. Hos oss använder vi exempelvis det för att kontrollera HTTP-status och om sidan är DOWN.<Br>
...
servern har med ytterligare en **Compose** som vi döper till **EndTime**. EndTime använder också uttrycket **utcNow()** och gör det direkt efter **HTTP** är klar. Här kan det uppstå problem om **HTTP** inte körs klart och får ett **Has failed** eller **Has timed out**,
...
Om **IfStatusCode500or503** är lika med 500 eller 503 är resultatet **True** och sätter vår variabel **WebsiteStatus** till **DOWN**. Om **IfStatusCode500or503** är **False**, alltså **HTTPStatus** är inte 500 eller 503, går vi vidare till vårt andra condition i detta block. <br>
...
så varje gång **IsAlertInactive** körs och Faultnode.se inte har kommit online igen går Logic App till **False** och inget e-post skickas.
